...
<header class="navbar navbar-inverse" role="banner">
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="<%=request.getContextPath()%>/logout.do?url=http://10.10.12.17/SpringPac4j/login.do"><img src="<%=request.getContextPath()%>/public/img/logo.png"></a>
	</div>
